...
An app for Brides and Grooms with a big list of things to do for their big day! It integrates with a backend, available here: https://github.com/HanaSoph/ToDoAppBackend
...
## Technologies
This app is made with JavaScript, React, Bootstrap and axios to link it to the back end database in AWS Lambda. 
...
The to do list title includes a dynamic number based on how many items are in that list. This list lets you either mark the item as complete, or delete the item if it's no longer required. 
